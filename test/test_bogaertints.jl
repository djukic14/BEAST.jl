...
BEAST.momintegrals!(op, x, x, t, t, z1, SE_strategy, BEAST.quadraturebuffer(SE_strategy))

EE_strategy = BEAST.BogaertSelfPatchStrategy(20)
BEAST.momintegrals!(op, x, x, t, t, z2, EE_strategy, BEAST.quadraturebuffer(EE_strategy))
...
BEAST.momintegrals!(op, x, x, t, s, z3, EE_strategy, BEAST.quadraturebuffer(EE_strategy))
...
BEAST.momintegrals!(op, x, x, t, s, z4, SE_strategy, BEAST.quadraturebuffer(SE_strategy))
...
BEAST.momintegrals!(op, x, x, t, s, z5, EE_strategy, BEAST.quadraturebuffer(EE_strategy))
...
BEAST.momintegrals!(op, x, x, t, s, z6, SE_strategy, BEAST.quadraturebuffer(SE_strategy))
...
BEAST.momintegrals!(op, x, x, t1, t2, z1, s1, BEAST.quadraturebuffer(s1))
BEAST.momintegrals!(op, x, x, t1, t2, z2, s2, BEAST.quadraturebuffer(s2))
BEAST.momintegrals!(op, x, x, t1, t2, z3, s3, BEAST.quadraturebuffer(s3))
...
fill!(z1, 0); BEAST.momintegrals!(op, x, x, t2, t3, z1, s1, BEAST.quadraturebuffer(s1))
fill!(z2, 0); BEAST.momintegrals!(op, x, x, t2, t3, z2, s2, BEAST.quadraturebuffer(s2))
fill!(z3, 0); BEAST.momintegrals!(op, x, x, t2, t3, z3, s3, BEAST.quadraturebuffer(s3))
...
fill!(z1, 0); BEAST.momintegrals!(op, x, x, t1, t1, z1, s1, BEAST.quadraturebuffer(s1))
fill!(z2, 0); BEAST.momintegrals!(op, x, x, t1, t1, z2, s2, BEAST.quadraturebuffer(s2))
fill!(z3, 0); BEAST.momintegrals!(op, x, x, t1, t1, z3, s3, BEAST.quadraturebuffer(s3))
